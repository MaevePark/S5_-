      ...
      <div id="footer">
        <div class="inner">
          <div class="footerContentWrap">
            <div class="footerContent1 -moveDom">
              <ul class="footerCs">
                <li class="title">엔보트 지점 안내</li>
                <li class="num">
                  <a href="#"><span>오전 11:00 - 오후 8:00 </span></a><br />
                  <span>
                    엔보트 로드샵 지점은 매주 월요일 정기 휴무입니다. <br />
                    <br />
                    <br />
                    <a href="#"><span>안양점 TEL</span> 070-8796-7633</a><br />
                    <span
                      >경기도 안양시 동안구 엘에스로23 JDO빌딩 1층<br />
                      <br />
                      <a href="#"><span>고양점 TEL</span> 070-4280-7633</a
                      ><br />
                      <span
                        >경기도 고양시 덕양구 중앙로184 1층<br />
                        <br />
                        <a href="#"><span>하남점 TEL</span> 070-7797-7633</a
                        ><br />
                        <span
                          >경기도 하남시 초이로52<br />
                          <br />
                          <a href="#"
                            ><span>더현대 서울점 TEL</span> 02-3277-0841</a
                          ><br />
                          <span
                            >서울특별시 영등포구 여의대로 108 더현대 서울 지하
                            2층<br />
                            <br />
                            <a href="#"><span>미아점 TEL</span> 02-2117-1866</a
                            ><br />
                            <span
                              ...
                              <br />
                              <a href="#"
                                ><span>판교점 TEL</span> 031-5170-1468</a
                              ><br />
                              <span
                                >경기도 성남시 분당구 판교역로146번길 20
                                현대백화점 판교점 4층 엔보트 시티<br />
                                <br />
                                <a href="#"
                                  ><span>오산점 TEL</span> 070-4123-3079</a
                                ><br />
                                <span>엔보트 카페 오산점 TEL</span>
                                070-4121-6901<br />
                                <span
                                  >경기도 오산시 독산성로 270번길 11 엔보트<br />
                                  <br />
                                  <a href="#"
                                    ><span>인천점 TEL</span> 070-8666-1119</a
                                  ><br />
                                  <span
                                    >인천광역시 미추홀구 인주대로 382 엔보트<br />
                                    <br />

                                    <ul class="footerReturn">
                                      <li class="title">반품배송지</li>
                                      <li>
                                        경기도 안양시 동안구 엘에스로 23 JDO빌딩
                                        1층 엔보트
                                      </li>
                                    </ul>
                                  </span></span
                ...
                <li class="contents">오전 11:00 - 오후 8:00</li>
                <li class="contents"></li>
                <li class="contents"></li>
              </ul>
            </div>
            <div class="footerContent2 -moveDom">
              <ul class="footerBank">
                <li class="title">무통장안내</li>
                <li class="contents">신한&nbsp;&nbsp;140-013-780113</li>
                <li class="contents2">예금주 : (주)제이디오</li>
              </ul>
              <ul class="footerLink">
                <li class="title">즐겨찾는메뉴</li>
                <div class="FavoriteLink">
                  <ul>
                    <li><a href="/board/list.php?bdId=event">이벤트</a></li>
                    <li><a href="/order/cart.php">장바구니</a></li>
                    <li><a href="/mypage/wish_list.php">찜한상품</a></li>
                    <li><a href="/mypage/order_list.php">주문조회</a></li>
                    <li><a href="/mypage/index.php">마이페이지</a></li>
                  </ul>
                </div>
              </ul>
              <ul class="footerBoard">
                ...
                <div class="BoardLink">
                  <ul>
                    ...
                    <li><a href="../board/list.php?bdId=event">이벤트</a></li>
                    <li>
                      <a href="../board/list.php?bdId=goodsqa">상품문의</a>
                    </li>
                    <li>
                      <a href="../board/list.php?bdId=goodsreview">상품후기</a>
                    </li>
          ...
          <div class="inner">
            ...
            <ul class="footerLink -moveDom">
              <li>
                ...
                <a href="../board/write.php?bdId=cooperation" class="displayLI"
                  >제휴/문의</a
                >
              </li>
            </ul>
          ...
          <div class="inner">
            <div class="footerInfo">
              <div class="footInfoList">
                ...
                <dl>
                  ...
                  <dd>
                    ...
                    <a
                      href="#"
                      class="btn_licensee_info"
                      onclick="gd_popup_bizInfo('4928700724'); return false;"
                      >사업자번호조회 &gt;</a
                    >
                  </dd>
                </dl>
              ...
              <div class="footInfoList">
                ...
                <dl>
                  <dt>주소 :</dt>
                  <dd>경기도 안양시 동안구 엘에스로 23 JDO빌딩 1층 엔보트</dd>
                </dl>
              </div>
              <div class="footInfoList">
                <dl>
                ...
                <dl>
                  <dt>메일 :</dt>
                  <dd>
                    <a href="mailto:godo@godo.co.kr" class="btn_email"
                      >shop_nvot@naver.com</a
                    >
                  </dd>
                </dl>
                <dl>
              ...
              <div class="copyright">
                COPYRIGHT (C) (주)제이디오 All Rights Reserved.
              </div>
            </div>
