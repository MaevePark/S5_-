...
<%--                  <form
                ...
                > --%>
                  <input
                    type="hidden"
                    name="token"
                    value="MTY3MjA0MjAwNzM2NzgzMDUzMDYzNjg0NjQ2OTYwMzE4NzYxMTY1OTk3"
                  />
                  ...
                  <div class="join_agreement_cont">
                    ...
                    <div class="join_agreement_box js_terms_view">
                      <div class="form_element">
                        ...
                        <label class="check_s" for="termsAgree1"
                          ><strong>(필수)</strong> 이용약관</label
                        >
                        <span
                          ><a
                            href="../service/agreement.php?code=001001"
                            target="_blank"
                            >전체보기</a
                          ></span
                        >
                      ...
                      <div class="agreement_box">
                        ...
                        사업자등록번호, 통신판매업신고번호, 개인정보
                        보호책임자등을 이용자가 쉽게 알 수 있도록 "몰"의 초기
                        ...
                        용역의 내용을 변경할 수 있습니다. 이 경우에는 변경된
                        재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화
                        또는 용역의 내용을 게시한 곳에 즉시 공지합니다.<br />
                        ...
                        중 다음 각호에 해당하지 않는 한 회원으로 등록합니다.<br />
                        ...
                        미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.<br />
                        ...
                        <br />
                        <br />
                        제9조(구매신청) "몰"이용자는 "몰"상에서 다음 또는 이와
                        유사한 방법에 의하여 구매를 신청하며, "몰"은 이용자가
                        구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게
                        제공하여야 합니다. 단, 회원인 경우 제2호 내지 제4호의
                        적용을 제외할 수 있습니다.<br />
                        1. 재화등의 검색 및 선택<br />
                        ...
                        등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수
                        없습니다.<br />
                        ...
                        수신확인통지를 합니다.<br />
                        ② 수신확인통지를 받은 이용자는 의사표시의 불일치등이
                        있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경
                        및 취소를 요청할 수 있고 "몰"은 배송전에 이용자의 요청이
                        있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다.
                        ...
                        제14조(환급)<br />
                        <br />
                        "몰"은 이용자가 구매신청한 재화등이 품절 등의 사유로
                        인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를
                        이용자에게 통지하고 사전에 재화 등의 대금을 받은
                        경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나
                        환급에 필요한 조치를 취합니다.<br />
                        <br />
                        <br />
                        제15조(청약철회 등)<br />
                        ...
                        ④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화등의
                        내용이 표시·광고 내용과 다르거나 계약내용과 다르게
                        이행된 때에는 당해 재화등을 공급받은 날부터 3월이내, 그
                        ...
                        이내에 이미 지급받은 재화등의 대금을 환급합니다. 이 경우
                        "몰"이 이용자에게 재화등의 환급을 지연한 때에는 그
                        지연기간에 대하여 공정거래위원회가 정하여 고시하는
                        지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br />
                        ② "몰"은 위 대금을 환급함에 있어서 이용자가 신용카드
                        또는 전자화폐 등의 결제수단으로 재화등의 대금을 지급한
                        때에는 지체없이 당해 결제수단을 제공한 사업자로 하여금
                        재화등의 대금의 청구를 정지 또는 취소하도록
                        요청합니다.<br />
                        ③ 청약철회등의 경우 공급받은 재화등의 반환에 필요한
                        비용은 이용자가 부담합니다. "몰"은 이용자에게
                        청약철회등을 이유로 위약금 또는 손해배상을 청구하지
                        않습니다. 다만 재화등의 내용이 표시·광고 내용과 다르거나
                        계약내용과 다르게 이행되어 청약철회등을 하는 경우
                        재화등의 반환에 필요한 비용은 "몰"이 부담합니다.<br />
                        ④ 이용자가 재화등을 제공받을때 발송비를 부담한 경우에
                        "몰"은 청약철회시 그 비용을 누가 부담하는지를 이용자가
                        알기 쉽도록 명확하게 표시합니다.<br />
                        <br />
                        <br />
                        제17조(개인정보보호)<br />
                        <br />
                        ① "몰"은 이용자의 정보수집시 구매계약 이행에 필요한
                        최소한의 정보를 수집합니다. 다음 사항을 필수사항으로
                        하며 그 외 사항은 선택사항으로 합니다.<br />
                        1. 성명<br />
                        2. 주소<br />
                        3. 전화번호<br />
                        4. 희망ID(회원의 경우)<br />
                        ...
                        공서양속에 반하는 정보를 몰에 공개 또는 게시하는 행위<br />
                        <br />
                        <br />
                        ...
                        부칙<br />
                        <br />
                        1. 이 약관은 2020년 02월 10일부터 적용됩니다.<br />
                      </div>
                      <!-- //agreement_box -->
                    </div>
                    <!-- //join_agreement_box -->
                    ...
                    <div class="join_agreement_box js_terms_view">
                      <div class="form_element">
                        ...
                        <span
                          ><a
                            href="../service/agreement.php?code=001003"
                            target="_blank"
                            >전체보기</a
                          ></span
                        >
...
<!--           <script type="text/javascript">
            $(document).ready(function () {
              ...
              $("#btnNextStep").click(function () {
                ...
                $(":checkbox.require").each(function (idx, item) {
                  ...
                  if (!$item.prop("checked")) {
                    pass = false;
                    $("strong.important_check", $formTerms)
                      .removeClass("dn")
                      .text($item.next().text() + "을 체크해주세요.");
                    _.delay(function () {
                      $item.focus();
                    }, 1000);
                    return false;
                ...
                if (pass) {
                  ...
                  if ($('input[name="RnCheckType"]').length > 0) {
                    switch ($('input[name="RnCheckType"]:checked').val()) {
                      case "ipin":
                        if (isMobile()) {
                          make_layer_popup("", "아이핀 인증");
                          $("meta[name='viewport']").attr({
                            content: "user-scalable=yes, width=480",
                          });
                      ...
                      case "authCellPhone":
                        if (isMobile()) {
                          ...
                          var callbackUrl =
                            "http://nvot.co.kr/member/authcellphone/dreamsecurity_result.php";
                          make_layer_popup(
                            protocol +
              ...
              $("#allAgree", $formTerms).change(function (e) {
                var $target = $(e.target),
                  $checkbox = $(":checkbox").not("#termsAgree"),
              ...
              $(".js_terms_view :checkbox", $formTerms).change(function (e) {
                ...
                var $target = $(e.target),
                  ...
                  $termsView = $target.closest(".js_terms_view");
                var isTermsAgreeSelect =
                  e.target.id === "termsAgree3" ||
                ...
                if (isTargetChecked) {
                  if (isTermsAgreeSelect) {
                    $termsView
                      .find(".agreement_choice_box label")
                      .addClass("on");
              ...
              if ($("#termsAgreeDiv").length > 0) {
                $("#termsAgreeDiv :checkbox", $formTerms).change(function (e) {
                  var $termsTarget = $(e.target),
                    $termsLabel = $termsTarget.siblings("label");
                  var isTermsTargetChecked =
                    $termsTarget.prop("checked") === true;
