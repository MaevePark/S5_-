				...
				<div class="inner">
					...
					<div class="headerSns">
						<a href="https://www.instagram.com/nvot_anyang/" target="_blank"><img
							src="https://cdn-pro-web-218-48.cdn-nhncommerce.com/biobkj2_godomall_com/data/skin/front/mplshop/_mplshop/images/sns/sns_st_04.png"
							alt="인스타그램" title=""></a> <a
							...
							target="_blank"><img
							src="https://cdn-pro-web-218-48.cdn-nhncommerce.com/biobkj2_godomall_com/data/skin/front/mplshop/_mplshop/images/sns/sns_st_08.png"
							alt="유튜브" title=""></a>
					</div>
					<!-- SNS 영역 끝 -->
					<!-- 상단 카테고리 영역 시작 -->
					<div class="headerMember">
						<ul>
							...
							<li class="headerCs"><a
								href="${pageContext.request.contextPath}/board">커뮤니티 </a>
			...
			<div class="inner">
						...
						<div aria-live="polite" class="slick-list" style="height: 110px">
							<div class="slick-track" style="opacity: 1; width: 5000px"
								...
								<div class="slick-slide slick-current slick-active"
									...
									<a href="http://nvot.co.kr/main/html.php?htmid=service/company2.html" tabindex="0">
										<img src="https://cdn-pro-web-218-48.cdn-nhncommerce.com/biobkj2_godomall_com/data/skin/front/mplshop/img/banner/slider_511517418/df01c110e50353b2650ea1e6fce0cdd3_35890.jpg" alt="본문 슬라이드 배너" title=""></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="headerLogo">
					<div class="m_out">
						...
						<img src="https://cdn-pro-web-218-48.cdn-nhncommerce.com/biobkj2_godomall_com/data/skin/front/mplshop/img/banner/76d9b45d23c48401f8a914cc9b035dbf_66272.png" alt="logo" title=""></a>
					</div>
					<div class="m_over">
						<a href="${pageContext.request.contextPath}/main">
						<img src="https://cdn-pro-web-218-48.cdn-nhncommerce.com/biobkj2_godomall_com/data/skin/front/mplshop/img/banner/149467a986169e7238fbd5d39ab48cca_46154.png" alt="logo" title=""></a>
					</div>
					<div class="asideBtn">
						...
						<div class="gnbMenuBox">
							...
							<ul class="menuCategory" style="overflow: visible">
								<li class="originCategory"><a
									href="${pageContext.request.contextPath}/product">PROMOTION</a>
								</li>
								<li class="originCategory"><a
									href="${pageContext.request.contextPath}/product">TENT
										&amp; TARP</a>
									<div class="subCategory depth1">
										<ul>
											<li class=" "><a href="/">TENT</a></li>
											<li class=" "><a href="/">TARP</a></li>
											<li class=" "><a href="/">TENT &amp; TARP ACC</a></li>
										</ul>
									</div>
								</li>
								<li class="originCategory"><a
									...
									<div class="subCategory depth1">
										<ul>
											<li class=" "><a href="/">SHELTER</a></li>
											<li class=" "><a href="/">SHELER ACC</a></li>
										</ul>
									</div>
								...
								<li class="originCategory"><a
									...
									<div class="subCategory depth1">
										<ul>
											...
											<li class=" "><a href="/">CHAIR</a></li>
											<li class=" "><a href="/">COT</a></li>
											<li class=" "><a href="/">STORAGE</a></li>
								...
								<li class="originCategory hasChild"><a
									...
									<div class="subCategory depth1">
										<ul><li class=" "><a href="/">SLEEPING BAG</a></li></ul>
									</div>
								</li>
								<li class="originCategory"><a
									...
									<div class="subCategory depth1">
										<ul>
											<li class=" "><a href="/">CUP</a></li>
											<li class=" "><a href="/">COOKWARE</a></li>
											<li class=" "><a href="/">ETC</a></li>
											<li class=" "><a href="/">COOLERS</a></li>
										</ul>
									</div>
									<button class="categoryMore"></button></li>
								<li class="originCategory"><a
									...
									<div class="subCategory depth1">
										<ul>
											<li class=" "><a href="/">LANTERN</a></li>
											<li class=" "><a href="/">STOVE</a></li>
											<li class=" "><a href="/">FIRE PITS</a></li>
								...
								<li class="originCategory"><a
									...
									<div class="subCategory depth1">
										<ul>
											<li class=" "><a href="/">OUTER</a></li>
											<li class=" "><a href="/">TOP</a></li>
											<li class=" "><a href="/">VEST</a></li>
											<li class=" "><a href="/">BOTTOM</a></li>
											<li class=" "><a href="/">ONE-PIECE</a></li>
											<li class=" "><a href="/">SET</a></li>
											<li class=" "><a href="/">ACC</a></li>
										</ul>
									</div>
									<button class="categoryMore"></button></li>
