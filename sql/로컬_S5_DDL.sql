...
CREATE TABLE "MEMBER" (
	...
	"MEMBER_EMAIL_AGREE"	NUMBER		NULL,
	"MEMBER_SMS_AGREE"	NUMBER		NULL
);
...
COMMENT ON COLUMN "MEMBER"."MEMBER_EMAIL_AGREE" IS '이메일 동의여부';
COMMENT ON COLUMN "MEMBER"."MEMBER_SMS_AGREE" IS 'SMS 동의여부';
